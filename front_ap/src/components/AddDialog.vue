<template>
    <div v-if="show" class="modal-shadow" @click.self="closeModal">
        <div class="container">
            <header>Написать </header>
            {{ event_id }}
            <textarea v-model="addText" placeholder="Введите сообщение..." rows="6"></textarea>
            <button class="firstNext next" @click="closeModal">Добавить</button>
        </div>
    </div>
</template>
